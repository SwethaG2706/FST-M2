...
public class Activity2 {
    ...
    public void addNewUserFromFile() throws IOException {
        ...
        String reqBody;
        reqBody = new String(String.valueOf(inputJSON.read()));
    ...
    public void getUserInfo() {
        ...
        // Assertion
        response.then().body("id", equalTo(2706));
        response.then().body("username", equalTo("SwethaG"));
        response.then().body("firstName", equalTo("Swetha"));
        response.then().body("lastName", equalTo("Gaddam"));
        response.then().body("email", equalTo("gaddamshwetha@mail.com"));
